...
form.addEventListener('submit',async event=>{
 ...
 try{
  const response=await fetch('/api/unlock-ads',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({email:form.email.value,website:form.website.value}),signal:AbortSignal.timeout(20000)});
